...
<div class="container-fluid">
    <form action="" id="manage-student">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="suser_no"  value="<?php echo isset($suser_no) ? $suser_no :'' ?>" required>
        </div>
        <div class="form-group">
            <label for="" class="control-label">Name</label>
            <input type="text" class="form-control" name="student_name"  value="<?php echo isset($student_name) ? $student_name :'' ?>" required>
        </div>
        <div class="form-group">
