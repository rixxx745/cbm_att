			...
			<form action="" id="manage-class">
				<div class="card">
					...
					<div class="card-body">
							...
							<div id="msg"></div>
							<select name="program_id" id="program_id" class="custom-select select2">
								<option value=""></option>
								<?php 
								$program = $conn->query("SELECT * FROM programs order by program asc");
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-primary edit_class" type="button" data-id="<?php echo $row['id'] ?>"  data-program_id="<?php echo $row['program_id'] ?>"  data-level="<?php echo $row['level'] ?>" data-section="<?php echo $row['section'] ?>" >Edit</button>
...
<script>
	...
	$('.edit_class').click(function(){
		...
		cat.find("[name='program_id']").val($(this).attr('data-program_id')).trigger('change')
