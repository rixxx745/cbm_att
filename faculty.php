					...
					<div class="card-body">
						<table class="table table-condensed table-bordered table-hover">
							...
							<tbody>
								<?php 
								$i = 1;
								$faculty = $conn->query("SELECT * FROM faculty order by faculty_name desc ");
								while($row=$faculty->fetch_assoc()):
								?>
								<tr>
									<td class="text-center"><?php echo $i++ ?></td>
									<td>
										<p> <b><?php echo $row['fuser_no'] ?></b></p>
									</td>
									<td>
										<p> <b><?php echo ucwords($row['faculty_name']) ?></b></p>
									</td>
									<td class="">
...
<script>
	...
	$('.delete_faculty').click(function(){
		_conf("Are you sure you want to delete this faculty?","delete_faculty",[$(this).attr('data-id')])
	})
